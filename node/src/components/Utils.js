export const fetchDataHandler = ({
    task: { bitrix_id: taskId, title },
    employee_id: { bitrix_id: emplId, full_name: fullName },
    pk,
    completed,
    comments,
    active,
    ...
    return {
        ...
        completed,
        comments,
        time: { active, startingTime, endingTime, totalTime },
    };
};
...
export const getCurrentDate = () => {
    ...
    const today = `${date.getFullYear()}-${month < 10 ? "0" + month : month}-${
        day < 10 ? "0" + day : day
    }`;
    return today;
};
